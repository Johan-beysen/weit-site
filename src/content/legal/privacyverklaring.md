---
title: "Privacyverklaring van WeIT"
version: "1.0"
date: 2026-09-20
status: "concept"
---

> **Concept – nog niet publiceren.** Vul minstens `[ONDERNEMINGSNUMMER]`, `[BTW-NUMMER]` en `[SUPABASE-PROJECTREGIO]` in. Bevestig vóór publicatie ook de verwerkersovereenkomst, effectieve bewaartermijn en doorgiftewaarborg van Web3Forms. Zie `PUBLICATIECHECKLIST.md` in de map `juridisch/` van het project.
...
- de website `https://weit.be`;
- het klantenportaal van WeIT;
